...
\title{\textbf{The Energy Crossover Effect: How Model Architecture Shapes Hardware Efficiency Across Generative AI Modalities}}

\author{
  Yongjun Kim$^{1}$, Seoksoo Kim$^{2,*}$ \\[6pt]
  \small $^{1}$Department of Software, Ajou University, Suwon, South Korea \\
  \small $^{2}$Department of Media and Visual Communications, Hannam University, Daejeon, South Korea \\
  \small $^{*}$Corresponding author: sskim@hnu.kr \\
  \small ORCID: Y. Kim 0000-0003-4234-4883; S. Kim 0009-0006-4970-9557
}
...
The crossover point $N^*$---where a GPU platform achieves equal energy to the edge device---exists only when $\beta_\text{GPU} < \beta_\text{edge}$ \textit{and} the intercept ratio permits crossing within practical ranges:
\begin{equation}
...
Measurement scripts, Colab notebooks, and analysis code are available at the same repository. All models used are publicly available via Hugging Face.
...
Y.K. conceived the study, designed experiments, performed measurements, analysed data, and wrote the manuscript. S.K. contributed domain expertise in multimedia systems and energy measurement methodology, and reviewed the manuscript.
...
In \textit{Proc. NeurIPS} \textbf{36} (2023).

\bibitem{kaplan2020scaling}
Kaplan, J. \textit{et al.}
Scaling laws for neural language models.
Preprint at \url{https://arxiv.org/abs/2001.08361} (2020).

\bibitem{mao2024green}
Mao, Y. \textit{et al.}
Green edge AI: A contemporary survey.
\textit{Proc.~IEEE} \textbf{112}(7), 880--911 (2024).
\url{https://doi.org/10.1109/JPROC.2024.3437365}

\bibitem{jegham2025hungry}
Jegham, N., Abdelatti, M., Elmoubarki, L. \& Hendawi, A.
How hungry is AI? Benchmarking energy, water, and carbon footprint of LLM inference.
Preprint at \url{https://arxiv.org/abs/2505.09598} (2025).

\bibitem{castano2025energy}
Iyengar, A., Han, J., Ruf, B., Grari, V., Detyniecki, M. \& Ermon, S.
Energy scaling laws for diffusion models: Quantifying compute and carbon emissions in image generation.
Preprint at \url{https://arxiv.org/abs/2511.17031} (2025).

\bibitem{xu2024edge}
Wang, X. \& Jia, W.
Optimizing edge AI: A comprehensive survey on data, model, and system strategies.
Preprint at \url{https://arxiv.org/abs/2501.03265v1} (2025).

\bibitem{schwartz2020green}
Schwartz, R., Dodge, J., Smith, N.~A. \& Etzioni, O.
Green AI.
\textit{Commun.~ACM} \textbf{63}(12), 54--63 (2020).
\url{https://doi.org/10.1145/3381831}

\bibitem{henderson2020towards}
Henderson, P. \textit{et al.}
Towards the systematic reporting of the energy and carbon footprints of machine learning.
\textit{J.~Mach.~Learn.~Res.} \textbf{21}(248), 1--43 (2020).

\bibitem{lacoste2019quantifying}
Lacoste, A., Luccioni, A., Schmidt, V. \& Dandres, T.
Quantifying the carbon emissions of machine learning.
Preprint at \url{https://arxiv.org/abs/1910.09700} (2019).

\bibitem{anthony2020carbontracker}
Anthony, L.~F.~W., Kanding, B. \& Selvan, R.
Carbontracker: Tracking and predicting the carbon footprint of training deep learning models.
In \textit{ICML Workshop on Challenges in Deploying and Monitoring ML Systems} (2020).

\bibitem{garcia2019estimation}
Garc\'{i}a-Mart\'{i}n, E., Rodrigues, C.~F., Riley, G. \& Grahn, H.
Estimation of energy consumption in machine learning.
\textit{J.~Parallel Distrib.~Comput.} \textbf{134}, 75--88 (2019).
\url{https://doi.org/10.1016/j.jpdc.2019.07.007}

\bibitem{ho2020denoising}
Ho, J., Jain, A. \& Abbeel, P.
Denoising diffusion probabilistic models.
In \textit{Proc. NeurIPS} \textbf{33}, 6840--6851 (2020).

\bibitem{vaswani2017attention}
Vaswani, A. \textit{et al.}
Attention is all you need.
In \textit{Proc. NeurIPS} \textbf{30} (2017).

\bibitem{touvron2023llama}
Touvron, H. \textit{et al.}
LLaMA: Open and efficient foundation language models.
Preprint at \url{https://arxiv.org/abs/2302.13971} (2023).

\bibitem{podell2023sdxl}
Podell, D. \textit{et al.}
